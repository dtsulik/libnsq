...
int nsq_pub_unbuffered_connect(struct NSQDUnbufferedCon *connset, const char *address,int port,
                                void(*status_change_callback)(struct NSQDUnbufferedCon *ucon,int state));
int nsq_unbuffered_publish(struct NSQDUnbufferedCon *connset, char *topic, unsigned char *msg, int size, int timeout_in_seconds, int wait_ok);
